...
export class DiscordAudioPlayer implements IAudioPlayer {
  ...
  play(resource: AudioResource): void {
    const resourceWithInternal = resource as AudioResource & { _internal?: DiscordAudioResource };
    const internal =
      resourceWithInternal._internal ?? (resource as unknown as DiscordAudioResource);
