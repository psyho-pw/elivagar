import {
  AudioPlayer,
  AudioResource as DiscordAudioResource,
  createAudioPlayer,
  entersState,
  joinVoiceChannel,
...
export class PlayerAdapter {
  ...
  public play(
    ...
    resource: DomainAudioResource | DiscordAudioResource,
  ): void {
    connection.subscribe(player);
    // Handle both domain and discord.js audio resources
    const resourceWithInternal = resource as DomainAudioResource & {
      _internal?: DiscordAudioResource;
    };
    const discordResource = resourceWithInternal._internal ?? (resource as DiscordAudioResource);
